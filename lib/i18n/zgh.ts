...
export const zgh: Dictionary = {
  ...
  carte: {
    ...
    drinksInviteEyebrow: 'ⵜⴰⵎⵓⵔⵜ ⵏ ⵉⵙⵙⵓⵏ',
    drinksInviteTitle: 'ⵉⵙⵙⵓⵏ, ⴽⵓⴽⵟⴰⵢⵍⵙ & ⵙⵓⴼⵜ',
    drinksInviteText:
      'ⵜⴰⵎⵓⵔⵜ ⵏ ⵉⵙⵙⵓⵏ: ⴰⵙⵙⵓⵎⵔ, ⵉⵙⴽⵓⵜⵍⵏ, ⴰⴱⵉⵔⵉⵜⵉⴼ, ⴷⵉⵊⵉⵙⵜⵉⴼ ⴷ ⵉⵙⵙⵓⵏ ⵉⵎⵙⵙⴰⵏ.',
    drinksInviteCta: 'ⵙⴽⵏ ⵜⴰⵎⵓⵔⵜ ⵏ ⵉⵙⵙⵓⵏ',
