import { galleryAltsFr } from '@/lib/gallery-data'
import type { PagesCopy } from '../types'

export const pagesDe: PagesCopy = {
  around: {
    introEyebrow: 'Paris 18',
    introTitle: 'Um uns herum',
    introText:
    ...
    localLinks: {
      ...
      clichy: {
        ...
        text: 'Sortie métro Linien 2 et 13 : un repas fait maison sans traverser tout Montmartre.',
      },
    },
  },
  gallery: {
  ...
  privatisation: {
    ...
    statPartialValue: '15+',
    statPartialLabel: 'Privatisierung partielle\ndès 15 couverts',
    statTotalValue: '40',
    statTotalLabel: 'Privatisierung totale\njusqu’à 40 couverts',
  ...
  montmartre: {
    ...
    distinguishItems: [
      'Hauptgerichte 100 % maison, préparés chaque matin avec des produits frais',
      ...
      'Täglich geöffnet · 10h – 00h',
    ],
    privatisationTitle: 'Privatisierung & groupes',
    privatisationText:
    ...
    photosLink: 'Photos',
    aroundLink: 'Um uns herum',
    accessContact: 'Accès & contact',
    bookingTitle: 'Reservieren à Montmartre',
  },
  pigalle: {
    introEyebrow: 'Paris 18 · Pigalle',
    introTitle: 'Restaurant à Pigalle',
    introText:
      'Un bistrot français calme, nur wenige Gehminuten de Pigalle et du Moulin Rouge.',
    ...
    onSiteItems: [
      ...
      'Täglich geöffnet · 10h – 00h',
      'Métro Pigalle (Linien 2 et 12) à deux pas',
    ],
    ...
    accessContact: 'Accès & contact',
    bookingTitle: 'Reservieren depuis Pigalle',
  },
  clichy: {
    introEyebrow: 'Paris 17 / 18 · Place de Clichy',
    introTitle: 'Restaurant Place de Clichy',
    introText:
      'Un bistrot de quartier authentique, nur wenige Gehminuten de la Place de Clichy.',
    metroTitle: 'Accès simple depuis Clichy',
    metroP1Before: 'Métro ',
    metroStrong1: 'Place de Clichy (Linien 2 et 13)',
    metroP1After:
      ' : quelques minutes à pied jusqu’à l’avenue Rachel. La Fourche (Linie 13) et Blanche (Linie 2) sont également sehr nahs. L’impasse est calme : idéal pour un repas d’affaires en journée ou un dîner en famille le soir.',
