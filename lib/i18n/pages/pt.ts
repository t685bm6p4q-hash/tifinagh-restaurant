...
export const pagesPt: PagesCopy = {
  around: {
    ...
    introTitle: 'À nossa volta',
    introText:
      'Un bistrô de barrio en el 17 avenue Rachel — entre Montmartre, Pigalle y Place de Clichy.',
    ...
    neighborhoodsIntroStrong: 'cozinha francesa tradicional',
    neighborhoodsIntro2: ', 100 % casera.',
    openPrefix: 'Abierto ',
    openEveryDay: 'todos os dias',
    ...
    localLinks: {
      ...
      pigalle: {
        ...
        text: 'A pocos minutos a pie de Pigalle: ideal antes o después de un espetáculo.',
      },
      clichy: {
  ...
  privatisation: {
    ...
    statPartialValue: '15+',
    statPartialLabel: 'Privatização parcial\ndesde 15 comensales',
    statTotalValue: '40',
    statTotalLabel: 'Privatização total\nhasta 40 comensales',
    ...
    formats: [
      ...
      'Antes del espetáculo (Pigalle / Moulin Rouge)',
      'Recepciones y eventos privados',
    ],
    howTitle: '¿Cómo funciona?',
    howText:
      'Llámenos o escríbanos con la fecha, el número de comensales y el tipo de evento. Le respondemos con una propuesta (menu, servicio, privatización parcial o total) — ',
    howStrong: 'siempre con presupuesto',
    whatsappQuoteMessage: 'Olá, me gustaría un presupuesto de privatización en Tifinagh.',
  ...
  montmartre: {
    ...
    introText:
      'Un auténtico bistrô de barrio, en la tranquila avenue Rachel — lejos del bullicio de las arterias turísticas.',
    distinguishTitle: 'Lo que nos distingue',
    distinguishItems: [
      'Pratos 100 % caseros, preparados cada mañana con productos frescos',
      'Carta breve de temporada + menu del día en PDF actualizado',
      'Terraza sombreada con parasoles rojos cuando el tiempo lo permite',
      'Ambiente bistrô parisino: madera, mantelería vichy, servicio acogedor',
      'Aberto todos os dias · 10:00 – 00:00',
    ],
    privatisationTitle: 'Privatização y grupos',
    privatisationText:
  ...
  pigalle: {
    ...
    introText:
      'Un bistrô francés tranquilo, a pocos minutos a pie de Pigalle y del Moulin Rouge.',
    whyTitle: 'Por qué cenar cerca de Pigalle en Tifinagh',
    whyP1Before:
      'Cada noche Pigalle atrae visitantes por sus espetáculos, teatros y energía. Muchos buscan después una mesa ',
    ...
    showTitle: 'Ideal antes o después de un espetáculo',
    showText:
    ...
    onSiteItems: [
      ...
      'Carta breve de temporada + menu del día en PDF',
  ...
  clichy: {
    ...
    introText:
      'Un bistrô de barrio auténtico, a pocos minutos a pie de Place de Clichy.',
    ...
    accessTitle: 'Un bistrô francés junto a la salida de metro Clichy',
    accessText:
      'Place de Clichy es un cruce práctico entre el distrito 17 y el 18. Para un almuerzo o cena sin cruzar todo Montmartre, Tifinagh ofrece cozinha francesa tradicional en el 17 avenue Rachel: productos frescos, platos generosos, ambiente de bistrô de verdad — no una mesa genérica de plaza turística.',
